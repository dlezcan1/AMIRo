...
... %         pred_results_tbl.layer_num == 1 ...
    ...
    pred_results_tbl.Tissue_Experiment(:) = "";
    pred_results_tbl.Tissue_Experiment(pred_sb_sl_mask | pred_sb_dl_mask) = "C-shape";
    pred_results_tbl.Tissue_Experiment(pred_db_sl_mask)                   = "S-shape";
    pred_results_tbl.Tissue_Experiment = strcat( ...
        pred_results_tbl.Tissue_Experiment, ...
        " ", ...
        pred_results_tbl.TissueTypes...
    );
...
%     );
    ...
    save(...
        fullfile( save_dir, "Prediction_Errors.mat" ),...
        'pred_results_tbl'...
    );
    fprintf( ... 
        "Saved experimental summary of errors to: %s/Prediction_Errors.mat\n",...
        save_dir ...
    );
       
    col_types = varfun(@class, pred_results_tbl, 'OutputFormat','cell');
    writetable( ...
        pred_results_tbl( ...
            :, ...
            pred_results_tbl.Properties.VariableNames(~strcmp(col_types, 'cell'))  ...
        ), ...
        fullfile(save_dir, "Prediction_Errors.xlsx") ...
    );
    fprintf( ... 
        "Saved experimental summary of errors to: %s/Prediction_Errors.xlsx\n",...
        save_dir ...
    );
...
%     plot_resutls_inputs{1}.train_mask = train_mask;
    ...
    % - all
    plot_results_inputs{4} = struct();
    plot_results_inputs{4}.mask = nodup_mask;
    plot_results_inputs{4}.file_prefix = "Prediction-Results_all";
    plot_results_inputs{4}.title_insert = "Experiments";
    plot_results_inputs{4}.num_layers = 1;
...
function plot_results( ...
    ...
    x_vars_labels_files = [
        ...
        "L_pred",            "Insertion Depth"          , " (%s)", "pred_insdepth";
        "dL",                "Insertion Depth Increment", " (%s)", "insdepthinc";
        "TissueTypes",       "Tissue Stiffness"         , ""     , "stiff";
        "Tissue_Experiment", "Experiment Configuration", "", "expmt"; 
    ];
