...
data_dir = '/Volumes/amiro_needle_data/3CH-4AA-0004/Insertion_Experiment_Results';
...
L_min = 35; % minimum reference insertion depth (for cut-off)
mask_L = act_result_tbl.L >= L_min;% & act_result_tbl.L <= 105;
...
for expmt = unique(act_result_tbl.Experiment)'
    ...
    for ins_hole = unique(act_result_tbl.Ins_Hole)'
        ...
        mask1 = mask_expmt & mask_ins_hole & mask_L & ...
            mask_c_1layer;
        ...
        mask2 = mask_expmt & mask_ins_hole & mask_L & ...
            mask_s_1layer;
        ...
        mask3 = mask_expmt & mask_ins_hole & mask_L & ...
            mask_c_2layer;
...
mask_c_1layer = mask_c_1layer & mask_L;
mask_s_1layer = mask_s_1layer & mask_L;
mask_c_2layer = mask_c_2layer & mask_L;
...
plot(act_result_tbl.L_ratio(mask_c_1layer & mask_soft1), log(act_result_tbl.kc1_ratio(mask_c_1layer & mask_soft1)), ...
    '.', 'Markersize', 20, 'DisplayName', '1-Layer C-shape: Soft \kappa_c'); hold on;
...
p_lsqr_all1 = act_result_tbl.L_ratio(mask_c_1layer) \ ...
              log(act_result_tbl.kc1_ratio(mask_c_1layer))

% entire C-shape insertion (kc1 and kc2)
L_ratio_cshape = [act_result_tbl.L_ratio(mask_c_1layer);
                  act_result_tbl.L_ratio(mask_c_2layer);
                  act_result_tbl.L_ratio(mask_c_2layer)];
kc_ratio_cshape = [act_result_tbl.kc1_ratio(mask_c_1layer);
                  act_result_tbl.kc1_ratio(mask_c_2layer);
                  act_result_tbl.kc2_ratio(mask_c_2layer)];

p_lsqr_cshape = L_ratio_cshape \ log(kc_ratio_cshape)

% plotting
xl = xlim;
x = linspace(0, max(act_result_tbl.L_ratio), 100);
y_soft1 = p_lsqr_soft1 * x;
y_hard1 = p_lsqr_hard1 * x;


plot(x, y_soft1, 'DisplayName', 'Soft \kappa_c fit', 'LineWidth',3);
plot(x, y_hard1, 'DisplayName', 'Hard \kappa_c fit', 'LineWidth',3);
